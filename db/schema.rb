...
ActiveRecord::Schema.define(version: 20_230_718_104_828) do
  ...
  create_table 'budgets', force: :cascade do |t|
    ...
    t.index %w[month year], name: 'index_budgets_on_month_and_year'
  ...
  create_table 'expenses', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[category_id status], name: 'index_expenses_on_category_id_and_status'
    t.index ['category_id'], name: 'index_expenses_on_category_id'
    t.index ['status'], name: 'index_expenses_on_status'
    t.index ['subcategory_id'], name: 'index_expenses_on_subcategory_id'
    t.index %w[user_id status], name: 'index_expenses_on_user_id_and_status'
  ...
  create_table 'wallets', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[month year], name: 'index_wallets_on_month_and_year'
    t.index %w[user_id month], name: 'index_wallets_on_user_id_and_month'
